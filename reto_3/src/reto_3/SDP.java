        ...
        do {
            ...
            switch (op) {
                case 1:
                    ...
                    break;
                case 2:
                    c.getCoincidencia(p, ingresoPlaca());
//                    c.display();
                    break;
            }
        } while (op >= 1 && op <= 2);
...
//        mostrarDatos(p);
    ...
    public static void datos(ArrayList<persona> p) {
        ...
        policia policia_4 = new policia("HBCEH", "Samantha", "Campos", "10253697841", "Calle 4C # 50 - 26", "3218975421");
        policia policia_5 = new policia("AAAAA", "Sebastian", "Castro", "10369874561", "Carrera 68 # 17 - 90", "3026985423");
