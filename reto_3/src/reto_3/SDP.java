...
public class SDP {
    ...
    public static void datos(ArrayList<persona> p) {
        policia policia_1 = new policia("HBABG", "Camilo", "Cardona", "1036145987", "Calle 3 # 58 - 36", "3214789652");
        policia policia_2 = new policia("ABCDE", "Esteban", "Montaño", "95748152", "Carrera 50 # 18 - 47", "3018459632");
        policia policia_3 = new policia("IHGEF", "Yuly", "Guzman", "47125963", "Transversal 73H # 75 - 63", "3107896352");
        policia policia_4 = new policia("CCDDE", "Samantha", "Campos", "10253697841", "Calle 4C # 50 - 26", "3218975421");
        ...
        ciudadano ciudadano_4 = new ciudadano("11001100110011111111", "Jose", "Cardenas", "55987451", "Calle 85 No 12-70. Apto 102, Bucaramanga", "3015894103");
        ciudadano ciudadano_5 = new ciudadano("00001111000011110000", "Jorge", "Arias", "10286984710", "Calle 34 No 10-25. Apto 204, Bucaramanga", "3135896478");
        p.add(policia_1);
        p.add(policia_2);
        p.add(policia_3);
        p.add(policia_4);
    ...
    public static String ingresoCromosoma() {
        String cromosoma;
        Scanner leer = new Scanner(System.in);
        System.out.print("Ingrese cromosoma: ");
        cromosoma = leer.nextLine();
        return cromosoma;
    }

    public static void accesoSPD(ArrayList<persona> p) {
        policia s = new policia();
        s.getCoincidencia(p, ingresoPlaca());
        System.out.println("Bienvenido SDP");
        for (persona placasPolicias : p) {
            if (placasPolicias instanceof policia) {
                if (s.getPorcentajeCoincidencia() != 100) {
                    System.out.println("El usuario no existe");
                    break;
                } else {
                    if (s.getPorcentajeCoincidencia() == placasPolicias.getPorcentajeCoincidencia()) {
    ...
    public static void getCulpable(ArrayList<persona> p) {
        ciudadano c = new ciudadano();
        c.getCoincidencia(p, ingresoCromosoma());
        System.out.println("El culpable es:  ");
        System.out.println();
        for (persona cromosomas : p) {
            if (cromosomas instanceof ciudadano) {
                if (c.getPorcentajeCoincidencia() == cromosomas.getPorcentajeCoincidencia()) {
                    cromosomas.display();
                }
            }
        }
