...
public class policia extends persona {
    ...
    @Override
    public void display() {
        System.out.println(super.getNombres() + "  " + super.getApellidos());
        System.out.println("Placa: " + this.placa);

    }

    @Override
    public void getCoincidencia(ArrayList<persona> p, String placa) {
        ...
        for (persona placasPolicias : p) {
            if (placasPolicias instanceof policia) {
                ...
                if (porcentaje > porcentajeMayor) {
                    ...
                    placasPolicias.setPorcentajeCoincidencia(porcentajeMayor);
